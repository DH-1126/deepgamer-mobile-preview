...
import { useAuthPrompt } from '../components/AuthAccess'
...
export function HomePage() {
  ...
  return (
    <main className="home-v2">
      ...
      <section id="game-selection" className="home-v2-discovery" aria-label="选择游戏">
        ...
        <button className="home-v2-inquiry" type="button" onClick={() => openProtected('/sell', '登录后继续卖号', '发布商品、快速回收和查看报价需要登录账号。')}><span><strong>不想等买家？直接卖给回收商</strong><small>多家回收商报价，先询价再决定</small></span><b>立即询价</b></button>
      </section>
      ...
      <section className="home-v2-about">
        ...
        <div className="home-v2-manifesto">
          ...
          <div className="home-v2-manifesto-foot"><div><i /><span>玩家不是用户，<br />是共建者。</span></div><figure aria-label="羊驼正式素材占位"><img src={asset('alpaca-placeholder.svg')} alt="" /><figcaption>羊驼 Mascot（待<br />替换正式素材）</figcaption></figure></div>
        </div>
        ...
        <section className="home-v2-story home-v2-wishes">
          ...
          <article className="home-v2-feedback"><div className="home-v2-feedback-copy"><h3>吐槽广场</h3><p>你觉得哪里难用？客服哪里让你不爽？<br />想要什么新功能？直接说。</p></div><div className="home-v2-small-mascot">羊驼</div><button type="button" onClick={() => navigate('/feedback')}>去吐槽</button><small>不满意？羊驼已经准备好替你吐口水了。</small></article>
